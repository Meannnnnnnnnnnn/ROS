...
#into a ROS image message an for converting ROS image message back to OpenCV images
...
subscriberNodeName='camera_sensor_subscrier'
...
rospy.Subscriber(topicName, Image, callbackFunctioin)
